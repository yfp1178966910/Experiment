    ...
    for class_value in range(len(csv_red)):
        ...
        while i < len(csv_red[class_value]):
            if class_value != 0 and class_value != 6:
                ...
                temp = 0
            if num >= csv_red[class_value][i]+temp and num <= csv_red[class_value][i+1]:
    ...
    for class_value in range(len(csv_trans)):
        ...
        while i < len(csv_trans[class_value]):
            if class_value != 0 and class_value != 6:
                ...
                temp = 0
            if num >= csv_trans[class_value][i]+temp and num <= csv_trans[class_value][i+1]:
        ...
        if ip.data.__class__.__name__ =='TCP':
            ...
            if ts-temp <= 1 :
                ...
                if len(flow_map) != 0:
                    ...
                    print(flow_map, len(flow_map), num)
